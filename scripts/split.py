...
train_data_path = Path.cwd() / Path('data') / 'split' / 'train_data.csv'
dev_data_path = Path.cwd() / Path('data') / 'split' / 'dev_data.csv'
test_data_path = Path.cwd() / Path('data') / 'split' / 'test_data.csv'
